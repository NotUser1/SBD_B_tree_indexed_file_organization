...
class BTree:
    ...
    @staticmethod
    def _count_occupied_rps(node: BTreeNode) -> int:
        if node is None:
            return 0
    ...
    def split_node(self, path, new_record_offset, new_record_key, leaf_offset=None, current_node=None, new_child_offset=None):
    ...
    # TODO: divide this into smaller sections and clean up (a lot of repetition inside the code)
    def handle_compensation(self, new_record_offset, new_record_key, leaf_offset=None, current_node=None, child_index=None,
                            parent_node=None, parent_offset=None):
    ...
    def handle_overflow(self, path, new_record_offset, new_record_key, leaf_offset=None, current_node=None,
        ...
        compensation_result = self.handle_compensation(new_record_offset,new_record_key, leaf_offset, current_node, child_index,
                                                       parent_node, parent_offset)
